...
| 09-07 17:48–18:00 | all five | fresh, formatted (model TBD – EVO wanted) | 4.13–4.21 | (running) |  |  |  | night shift, five loggers; on EVO expect 12–14 h → ~06:00–08:00 9/8, on high-power cards only ~8 h → ~02:00 (read the card models off and check the 01:02 forecast) |
