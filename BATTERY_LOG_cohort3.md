...
| **9/11 08:04–09:48** AM | **EVO 512 all five, fresh cards swapped in (0% at restart)** – CORRECTED 9/11 20:00: the 09-10 cards were taken to the lab intact, NOT formatted (lab: only the newest record deleted after backup; the lane-ON records stay on them for the maker's re-download test) | Fresh (ads idle before the Start / heartbeat at Start): SF07 4.10 / 4.12, SF08 4.08 / 4.10, **SF09 3.98 / 4.00 – 200 mV under the 4.18 rule, it reaches the knee first → PM round by ~16:30, SF09 first**, SF10 4.24 / 4.26, SF12 4.24 / 4.24 (capacity of the day cells not stated). | Night cells (**all five 1000 mAh**) **manually Stopped 08:06–08:24 at 3.64–3.73 V real after 12.5–12.6 h** (SF07 3.70, SF08 3.64, SF09 3.67, SF10 3.73, SF12 3.65; end anchors 15–26 each; none auto-stopped, SF08 past the knee and diving 46 mV/h at the Stop). Phase-matched against the 900s of the 9/9 night (3.48–3.64 at 12.5–12.9 h): +20 (SF08) … +250 mV (SF10) → **the 1000 mAh cells buy 0.5–1.5 h, not more**; SF08's 1000 was the weakest for the third time (9/6, 9/9, 9/10 nights) → number the cells from now on. **SF12's ad rec-counter froze 07:59:46–08:22 while it recorded on** (second telemetry freeze after SF07 9/5 05:36–05:56; the forecast flagged REC-FROZEN) → connected 08:22, heartbeat rec advancing, 25 anchors, clean Stop 08:24:11, **no reset**. Restarts: SF07 09:16:16, SF08 09:19:31 (its first Start 09:17:54 got no ack and the firmware aborted it 33 s later with **ERR 0602 F00 D20 – new code**; the retry was fine), SF09 09:22:25, SF10 09:24:41, SF12 09:47:47 (**SF12 was unreachable 08:26–09:44 – operator suspects the SD card slot; probe possibly broken – incident log 09:47**). Every logger ran a 30–100 s trial session before its final Start (tiny stubs on the cards). RTC writes only on idle loggers; mic off read back on all five before the Starts. |
| **9/11 18:22–19:24** evening | **EVO 512 – the 09-10 cards back from the lab** (46% on SF07/SF09/SF10/SF12 = 65% minus the deleted night record, SF08 23%; lane-ON records still on them, do NOT format) | Fresh (heartbeat at Start / ads idle at 19:41): SF07 4.17 / 4.08, SF08 4.20 / 4.08, SF09 4.20 / 4.08, SF10 4.12 / 4.06, SF12 4.21 / 4.10 (capacity not stated by the operator). Final Starts SF07 19:14:50, SF08 19:17:16, SF09 19:19:47, SF10 19:22:07, SF12 19:24:28, each after a ~33 s trial session; mic off read back on all five; RTC writes only on idle loggers; start anchors 24–27 each. **19:40: five non-implanted females released into the paddock (operator) – 10 animals from here.** | Day cells: knee anchor pass 16:51–16:58 (14–20 anchors, 65–96 s each, no RTC writes), then per the 9/6 protocol. **SF09 (installed at 3.98 V) auto-stopped ~17:32–17:36 at the 3.40 line after 8.2 h** (ad counter frozen at 29388 s; last touch 16:54:37–16:55:47, 15 anchors at 3.62 → tail ~40 min) – the round came before the other four: manual Stops **SF08 18:23:51 3.63, SF10 18:25:50 3.72, SF07 18:27:26 3.65, SF12 18:29:17 3.73 V real after 8.7–9.2 h** (end anchors 15–21 each). A 3.98 V install = 8.2 h to auto-stop vs 9+ h still above the knee for the 4.10–4.24 installs: the 4.18 rule again. |
| **9/12 08:51–10:21** FINAL – no swap | the same cards (not formatted; 50–73% at the end) | **No cells installed: the operator ended neurologger recording** (09:00: 'this is the last one, no more swaps'). | Knee anchor pass 08:51:34–08:58:56 (15/14/16/16/25 anchors, 65–120 s, heartbeat 3.52–3.63 V, no RTC or config writes), then the auto-stop protocol. **The five night cells ran 14.5–15.1 h – the longest of the cohort** (previous best 14.1–14.3 h on 9/3), installed at 4.12–4.21 V and auto-stopping at 3.40–3.48 V: **SF12 09:53:39 (14.48 h) and SF10 09:54:07 (14.53 h) confirmed; SF07 10:19:37 (15.07 h), SF09 10:19:40 (14.99 h), SF08 10:20:40 (15.05 h) unconfirmed – the console's BLE scan stopped at 10:20:53, and a dead feed looks like a frozen counter.** The dive began ~08:00 (20–31 → 60–120 mV/h), so the 07:21 forecast (11:58–16:09) was 2–6 h late; the 3.5 V rule placed the pass. Watchdog muted 09:35 (neurologger_alive_MUTED.txt). |
| **9/12 ~11:00 HOME CAGE** (after the field phase ended 10:10) | the same cards, not formatted | **Started from another laptop – no console log on this PC**: fresh cells of unstated capacity/voltage on all five, no sync, no anchors, run to auto-stop (expect 12.5–15 h → ends ~23:30–02:00). | Not a paddock session: home-cage sleep record with the logger RTC as the only clock; the newest record on each card; nothing in this log's cell table because nothing was measured here. Field recorders and watchdogs were all stopped 11:14–11:19 (incident log). |
...
| 09-11 09:15 | SF07 | EVO 512 (fresh card, 0%) | 4.12 | 09-11 18:27 | 3.66 | 3.65 | 9.2 | day cell (capacity not stated); ad idle 4.10; final Start 09:16:16; knee anchors 16:51 (20); manual Stop for the round (15 anchors) |
| 09-11 09:18 | SF08 | EVO 512 (fresh card, 0%) | 4.10 | 09-11 18:24 | 3.64 | 3.63 | 9.1 | day cell; ad idle 4.08 (under the 4.18 rule); first Start 09:17:54 failed (ERR 0602), final Start 09:19:31; knee anchors 16:53 (16); manual Stop for the round (16 anchors), first of the four |
| 09-11 09:21 | SF09 | EVO 512 (fresh card, 0%) | 4.00 | 09-11 ~17:34 | 3.40 | – | 8.2 | day cell; **ad idle 3.98 – 200 mV under the 4.18 rule → AUTO-STOPPED ~17:32–17:36 at the 3.40 line** (ad counter frozen at 29388 s; 3.60 first read 16:41, 3.62 at the knee anchors 16:54:37–16:55:47, 15 anchors = last touch, tail ~40 min); idle RTC write 18:24 before the swap |
| 09-11 09:24 | SF10 | EVO 512 (fresh card, 0%) | 4.26 | 09-11 18:26 | 3.72 | 3.72 | 9.0 | day cell; ad idle 4.24; final Start 09:24:41; knee anchors 16:55 (14); manual Stop for the round (16 anchors) |
| 09-11 09:45 | SF12 | EVO 512 (fresh card, 0%) | 4.24 | 09-11 18:29 | 3.74 | 3.73 | 8.7 | day cell; ad idle 4.24; final Start 09:47:47 (unreachable 08:26–09:44, card slot suspected; **probe possibly broken – lab measured 9/11 19:40: NOT broken, shanks 1 and 4 have a loosening contact (half amplitude since 9/10 afternoon, intermittent whole-shank opens on the 9/10 night)**); knee anchors 16:57 (15); manual Stop for the round (21 anchors), best of the five |
| 09-11 19:14 | SF07 | EVO 512 (09-10 card back, 46%) | 4.17 | 09-12 ~10:20 | 3.48 | 3.48 | 15.1 | **LAST CELL of the cohort**; final Start 19:14:50 (27 anchors); knee anchors 08:51:34–08:52:44 (15); auto-stop at/after 10:19:37 (rec 54,262 s) – unconfirmed, the console feed died 10:20:53 |
| 09-11 19:16 | SF08 | EVO 512 (09-10 card back, 23%) | 4.20 | 09-12 ~10:21 | 3.42 | 3.42 | 15.1 | **LAST CELL**; final Start 19:17:16 (24 anchors); knee anchors 08:52:54–08:53:59 (14); auto-stop at/after 10:20:40 (rec 54,189 s) – unconfirmed (feed died 12 s later) |
| 09-11 19:19 | SF09 | EVO 512 (09-10 card back, 46%) | 4.20 | 09-12 ~10:20 | 3.42 | 3.42 | 15.0 | **LAST CELL**; final Start 19:19:47 (24 anchors); knee anchors 08:55:31–08:56:46 (16); auto-stop at/after 10:19:40 (rec 53,965 s) – unconfirmed |
| 09-11 19:21 | SF10 | EVO 512 (09-10 card back, 46%) | 4.12 | 09-12 09:54:07 | 3.40 | 3.40 | 14.5 | **LAST CELL**; final Start 19:22:07 (25 anchors); knee anchors 08:54:11–08:55:21 (16); **auto-stop 09:54:07 confirmed** (rec 52,298 s; counter frozen at 3.40 V for the next 26 min while the others advanced) |
| 09-11 19:23 | SF12 | EVO 512 (09-10 card back, 46%) | 4.21 | 09-12 09:53:39 | 3.40 | 3.40 | 14.5 | **LAST CELL**; final Start 19:24:28 (25 anchors); knee anchors 08:56:56–08:58:56 (25); **auto-stop 09:53:39 confirmed** (rec 52,137 s); first of the five to finish |
...
10. **The cohort's longest cells were the last ones: 14.5–15.1 h** (installed 4.12–4.21 V on 9/11 19:14–19:24, auto-stop 3.40–3.48 V), against 12.5–12.9 h for the same class of cell on the nights before. The difference is the install voltage and an undisturbed session: nothing was connected between the Start and the knee pass 13.5 h later. The 4-h-slope forecast again under-read the dive (07:21 run said 11:58–16:09; the real stops were 09:53–10:21) — past the knee, trust the 3.5 V rule.
