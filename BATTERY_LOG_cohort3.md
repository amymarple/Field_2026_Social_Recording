...
| 09-10 08:24–08:35 | all five | EVO 512 (24%, not formatted) | 4.19–4.25 | (running) |  |  |  | day shift, all 900 mAh, every cell ≥ 4.18; knee ~19:40–20:40, auto-stop ~21:00–22:00; evening round 18:00. **14:40–14:54: ADC (“microphone”) lane switched ON on all five for body temperature → every session split by a BLE Stop/Start (new Starts 14:42–14:54; SF12/SF09/SF08 got stuck, were RESET by the operator, Resynced idle and restarted 15:05/15:07/15:10 — lane ON on all five from then), cells untouched; the lane adds load → compare tonight's slope with the 61–66 mV/h measured before 14:40.** 16:36 check: no extra drain visible yet (0 mV/h on all five over the first 80 min vs 15–32 in the reference batches at the same cell age — too short to conclude; physically the lane costs <1 mA). Day cells at 8 h 3.80–3.84 V, 30–70 mV above the 9/8–9/9 EVO-512 batches → knee ~19:00–19:30 (SF07 first), auto-stop ~21:15–22:15. **🔋 TONIGHT: ALL FIVE on 1000 mAh (803060) at the evening round (operator 16:45)** — first all-1000 night and first ADC-on night: CORRECTION 17:00: the 1000s are NOT full at 4.08–4.12 — SF12's 1000 went in at 4.19 V on 9/6 and ran best (3.74 at 12 h), the 4.06–4.12 installs of 9/7–9/10 were undercharged and ran 900-class → charge every 1000 to its rated 4.2 V, let the CV phase terminate, expect 4.16–4.20 under load at install (same ≥4.18 rested rule as the 900s); the ADC cost cannot be read against the 900-mAh nights — use SF08/SF12's own 1000 history (3.70–3.74 V at 12 h) and tomorrow's 900 day shift; if the 1000s deliver their rating expect 13–14 h (auto-stop ~08:00–09:00 9/11), if they run 900-class as the two did on 9/7 and 9/10 the round is 07:00 as usual — the 01:02 forecast decides. Format all cards at the 9/11 AM round. |
