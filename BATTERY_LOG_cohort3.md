...
| **9/9 08:16–09:14** AM | **ALL FIVE CARDS FORMATTED** (0–2% at restart). **EVO 256 on SF09 for the day-shift power test; SF07/SF08/SF10/SF12 stay on EVO 512.** | Fresh (heartbeat, under load): SF07 4.22, SF08 4.14, SF09 4.21, SF10 4.22, SF12 4.12. | Night cells **manually Stopped 08:16–08:22 at 3.58–3.67 V after 12.6 h on EVO 512** – none auto-stopped; end clusters 15–19 anchors (67–81 s), SF10's Stop carried its commit receipt O000000000012F400. Overnight connect-only pass 03:17–03:27 (SF07 33, SF08 22, SF09 19, SF10 14, SF12 20) despite the rats being scattered. Restarts 09:03–09:14 (Resync on idle loggers only, guard files, 14–16 start anchors) = ~50-min fleet gap. 12.6 h is the best EVO-512 night of the cohort so far. |
...
| 09-09 09:03–09:14 | all five | **EVO 256 on SF09**, EVO 512 on the rest (all formatted) | 4.12–4.22 | (running) |  |  |  | **day shift + EVO 256 power test on SF09** – compare SF09's 2–8 h slope (≈ 11:00–17:00) against its own EVO-512 days (9/8 day 51, 9/8 night, 9/6) and against the other four today; bench predicts +7 mV/h and ~1–1.5 h shorter life |
