...
| 09-08 19:37–19:48 | all five | EVO 512 (not formatted, 45%) | 4.16–4.22 | (running) |  |  |  | night shift, all properly charged; expect 12–12.5 h → ~07:40–08:20 on 9/9; **9/9 AM: format all cards; put an EVO 256 on SF09 for the day-shift power test (see the experiment file), everything else EVO 512** |
